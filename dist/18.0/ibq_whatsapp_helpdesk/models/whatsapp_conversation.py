...
class WhatsappConversation(models.Model):
    ...
    def _notify_dashboard(self, event):
        ...
        # _sendone rather than _sendmany: Odoo 18 dropped the batch helper and
        # kept only this one, whose signature is identical in both. One call
        # per agent costs little for a handful of watchers.
        bus = self.env["bus.bus"].sudo()
        for partner in partners:
            bus._sendone(partner, "ibq_whatsapp/dashboard", payload)
